...
@Component({
  selector: 'app-catalog-product-control',
  templateUrl: './catalog-product-control.component.html',
  styleUrls: ['./catalog-product-control.component.scss']
})
export class CatalogProductControlComponent implements OnInit {
  public image : any = []
